...
public class InstructorController {
	...
	public ResponseEntity<List<InstructorDTO>> getAllInstructors() {
		...
		List<InstructorDTO> instructorsDto = instructorService.findAll().stream().map(mapper::instructorToInstructorDto)
				.toList();
	...
	public ResponseEntity<?> updateInstructor(@PathVariable("instructorId") int instructorId,
