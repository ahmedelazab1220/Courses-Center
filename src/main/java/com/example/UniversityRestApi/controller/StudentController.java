...
public class StudentController {
	...
	public ResponseEntity<StudentDTO> assignCoursesToStudent(@PathVariable("studentId") int studentId , @PathVariable("courseId") int courseId){
	...
	public ResponseEntity<?> updateInstructor(@PathVariable("studentId") int studentId , @RequestBody Map<String , Object> fields){
