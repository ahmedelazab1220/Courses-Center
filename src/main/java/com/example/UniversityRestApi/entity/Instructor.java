...
public class Instructor {
	...
	public Instructor(int id, String firstName, String lastName,
			...
			String hobby, List<Course> courses) {
		this.id = id;
	...
	public String toString() {
		return "Instructor(id=" + this.getId() + ", firstName=" + this.getFirstName() + ", lastName="
				+ this.getLastName() + ", email=" + this.getEmail() + ", phoneNumber=" + this.getPhoneNumber()
				+ ", youtubeChannel=" + this.getYoutubeChannel() + ", linkedin=" + this.getLinkedin() + ", facebook="
				+ this.getFacebook() + ", github=" + this.getGithub() + ", hobby=" + this.getHobby() + ", courses="
				+ this.getCourses() + ")";
	}
	...
	public @Pattern(regexp = "^[a-zA-Z][a-zA-Z0-9._]{0,24}@gmail\\.com$", message = "use characters from a to z , A to Z , numbers from 0 to 9 , and special characters (. , _) only allowed") @NotNull(message = "Email Is Required") String getEmail() {
		return this.email;
	}

	public @Pattern(regexp = "^01[012][0-9]{8}$", message = "use an egyptian number to log in") @NotNull(message = "PhoneNumber Is Required") String getPhoneNumber() {
	...
	public @Pattern(regexp = "https?:\\/\\/(?:www\\.)?linkedin\\.com\\/(?:in|pub)\\/[a-zA-Z0-9-]+", message = "LinkedIn Link Not Valid") String getLinkedin() {
		return this.linkedin;
	}

	public @Pattern(regexp = "https?:\\/\\/(?:www\\.)?facebook\\.com\\/(?:profile\\.php\\?id=)?(?:[a-zA-Z0-9.-]+)", message = "FaceBook Link Not Valid") String getFacebook() {
		return this.facebook;
	}

	public @Pattern(regexp = "https?:\\/\\/(?:www\\.)?github\\.com\\/[a-zA-Z0-9-]+", message = "Github Link Not Valid") String getGithub() {
		return this.github;
	}
